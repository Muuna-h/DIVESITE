      ...
      <div className="relative z-10">
        <div className="mb-12 flex flex-col sm:flex-row items-center justify-between text-center sm:text-left">
          <div className="mb-4 sm:mb-0">
            <h1 className="text-4xl sm:text-5xl w-auto font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500 pb-2">
              Tech Discussion Forum
            </h1>
            <p className="text-muted-foreground text-base sm:text-lg">
              Join the conversation about technology, programming, and more
            </p>
          </div>
          {isAuthenticated && (
