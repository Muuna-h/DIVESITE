  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="prose max-w-full">
        ...
        <p>
          Like any other website, Dive Tech uses 'cookies'. These cookies are used to store information
        ...
        <p>
          ...
          used in their respective advertisements and links that appear on Dive Tech, which are sent
        ...
        <p>
          Note that Dive Tech has no access to or control over these cookies that are used by third-party
          advertisers.
        </p>

        <h2 className="text-2xl font-bold mt-6 mb-2">Third Party Privacy Policies</h2>
        <p>
          Dive Tech's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
        ...
        <p>
          Dive Tech does not knowingly collect any Personal Identifiable Information from children under the
        ...
        <p>
          ...
          regards to the information that they shared and/or collect in Dive Tech. This policy is not
