  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="prose max-w-full">
        <p>
          At Dive Tech, accessible from divetech.space , one of our main priorities is the privacy of our
          visitors. This Privacy Policy document contains types of information that is collected and recorded by
          Creative Tech Blog and how we use it.
        </p>
        ...
        <p>
          Dive Tech Blog follows a standard procedure of using log files. These files log visitors when they
        ...
        <h2 className="text-2xl font-bold mt-6 mb-2">Cookies and Web Beacons</h2>
        <p>
          Like any other website, Creative Tech Blog uses 'cookies'. These cookies are used to store information
        ...
        <h2 className="text-2xl font-bold mt-6 mb-2">Privacy Policies</h2>
        <p>
          You may consult this list to find the Privacy Policy for each of the advertising partners of Creative Tech
          Blog.
        </p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
          used in their respective advertisements and links that appear on Creative Tech Blog, which are sent
        ...
        <p>
          Note that Creative Tech Blog has no access to or control over these cookies that are used by third-party
          advertisers.
        </p>

        <h2 className="text-2xl font-bold mt-6 mb-2">Third Party Privacy Policies</h2>
        <p>
          Creative Tech Blog's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
        ...
        <p>
          Creative Tech Blog does not knowingly collect any Personal Identifiable Information from children under the
        ...
        <h2 className="text-2xl font-bold mt-6 mb-2">Online Privacy Policy Only</h2>
        <p>
          This Privacy Policy applies only to our online activities and is valid for visitors to our website with
          regards to the information that they shared and/or collect in Creative Tech Blog. This policy is not
